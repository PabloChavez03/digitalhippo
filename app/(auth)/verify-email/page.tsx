        ...
        <div className="flex h-full flex-col items-center justify-center space-y-1">
          ...
          {toEmail ? (
            <p className="text-center text-muted-foreground">
              We&apos;ve sent verification link to <span className="font-semibold">{toEmail}</span>.
            </p>
          ) : (
            <p className="text-center text-muted-foreground">We&apos;ve sent a verification link to your email.</p>
          )}
        </div>
      )}
    </div>
